---
title: "Effect size calculation - Versaci & Laje (2026), Tapping force variability influences temporal precision in paced finger tapping"
output: pdf_document
date: "2024-07-01"
---
...
model_SDACVF_etap <- eta_squared(model_SDACVF, partial=TRUE, alternative='two.sided',ci=0.9875) # Bonferroni-corrected CI (4 comparisons)
model_SDACVF_etag <- eta_squared(model_SDACVF, generalized=TRUE, alternative='two.sided',ci=0.9875) # Bonferroni-corrected CI (4 comparisons)
...
model_SDFF <- aov_4(SDF ~ F_center + Attention + Feedback
						...
						factorize = FALSE,
						anova_table = list(es=c("ges","pes"), sig_symbols=rep("",4)))
model_SDFF_etap <- eta_squared(model_SDFF, partial=TRUE, alternative='two.sided',ci=0.9875) # Bonferroni-corrected CI (4 comparisons)
model_SDFF_etag <- eta_squared(model_SDFF, generalized=TRUE, alternative='two.sided',ci=0.9875) # Bonferroni-corrected CI (4 comparisons)
...
model_CVFF <- aov_4(CVF ~ Finv_center + Attention + Feedback
						...
						factorize = FALSE,
						anova_table = list(es=c("ges","pes"), sig_symbols=rep("",4)))
model_CVFF_etap <- eta_squared(model_CVFF, partial=TRUE, alternative='two.sided',ci=0.9875) # Bonferroni-corrected CI (4 comparisons)
model_CVFF_etag <- eta_squared(model_CVFF, generalized=TRUE, alternative='two.sided',ci=0.9875) # Bonferroni-corrected CI (4 comparisons)
...
model_MSJF <- aov_4(lognormMSJ ~ lognormF_center + Attention + Feedback
						...
						factorize = FALSE,
						anova_table = list(es=c("ges","pes"), sig_symbols=rep("",4)))
model_MSJF_etap <- eta_squared(model_MSJF, partial=TRUE, alternative='two.sided',ci=0.9875) # Bonferroni-corrected CI (4 comparisons)
model_MSJF_etag <- eta_squared(model_MSJF, generalized=TRUE, alternative='two.sided',ci=0.9875) # Bonferroni-corrected CI (4 comparisons)
